...
<section class="section" style="padding-top:16px;">
    <div class="container">
        <div class="section-head">
            <div>
                <h2>Admin panel</h2>
                <div class="sub" style="margin:0;">Manage domains, users, DNS servers and settings.</div>
            </div>
        ...
        <div class="admin-grid">
            <aside class="admin-side">
                ...
                <a href="<?php echo url('admin/dns-server.php'); ?>" class="<?php echo $current === 'dns-server.php' ? 'active' : ''; ?>">DNS Server</a>
            </aside>
